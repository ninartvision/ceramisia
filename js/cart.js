  ...
  function createCartDrawer() {
    ...
    drawer.innerHTML =
      ...
      '<div class="cart-drawer__footer">' +
        ...
        '</button>' +
        '<div class="cart-drawer__cards footer-cards" aria-label="Accepted payment cards">' +
          '<span class="footer-card-badge footer-card-badge--visa"><img src="/images/payment/visa.svg?v=4" alt="Visa" width="44" height="18" decoding="async" loading="lazy"></span>' +
          '<span class="footer-card-badge footer-card-badge--mc"><img src="/images/payment/mastercard.svg?v=3" alt="Mastercard" width="30" height="18" decoding="async" loading="lazy"></span>' +
        '</div>' +
        '<p class="cart-drawer__legal">' +
          (lang === 'ge' ? 'გადახდით ეთანხმებით ' : 'By paying you agree to ') +
          '<a href="/terms/">' + (lang === 'ge' ? 'მომსახურების პირობებს' : 'Terms') + '</a>' +
          (lang === 'ge' ? ' და ' : ' and ') +
          '<a href="/privacy/">' + (lang === 'ge' ? 'კონფიდენციალურობის პოლიტიკას' : 'Privacy Policy') + '</a>.' +
        '</p>' +
      '</div>';
